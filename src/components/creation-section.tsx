  ...
  return (
    <section className="container mx-auto px-4 py-20">
      <div className="max-w-3xl mx-auto text-center mb-16">
        <h2 className="text-3xl font-bold mb-4">From tracking to savings.</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        <div className="bg-white rounded-xl p-6 shadow-md">
          ...
          <h3 className="text-lg font-medium mb-2">Track Daily Meals</h3>
        ...
        <div className="bg-white rounded-xl p-6 shadow-md">
          ...
          <h3 className="text-lg font-medium mb-2">Analyze Patterns</h3>
          <p className="text-sm text-gray-600">
        ...
        <div className="bg-white rounded-xl p-6 shadow-md">
          ...
          <h3 className="text-lg font-medium mb-2">Optimize Expenses</h3>
          <p className="text-sm text-gray-600">
